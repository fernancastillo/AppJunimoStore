...
fun provideProductoViewModelFactory(context: Context): ProductoViewModelFactory {
    ...
    return ProductoViewModelFactory(application.productoRepository, application.authRepository, ordenRepository)
}
        ...
        Box(
            ...
            Column(
                ...
                producto?.let { p ->
                    ...
                    Spacer(modifier = Modifier.height(16.dp))
                    Button(onClick = { navController.popBackStack() }, colors = ButtonDefaults.buttonColors(containerColor = AmarilloMostaza)) { 
